          ...
          <ul className="flex space-x-6">
            ...
            <li className="relative group">
              ...
              >
                <Link
                  to="/faq"
                  className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-emerald-900"
                >
                  FAQ
                </Link>
                <Link
          ...
          {username ? (
            <div className="relative group">
              <div className="flex items-center cursor-pointer text-emerald-800 text-lg font-medium">
                Hi, {username} <FaChevronDown className="ml-1 text-xs" />
              </div>

              <div className="absolute right-0 top-full mt-1 bg-white shadow-lg rounded-lg overflow-hidden transition-all duration-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible">
                <button
                  onClick={() => {
                  ...
                  className="w-full px-4 py-2 text-left text-gray-700 hover:bg-emerald-50 hover:text-emerald-900"
                >
                  Logout
                </button>
              </div>
